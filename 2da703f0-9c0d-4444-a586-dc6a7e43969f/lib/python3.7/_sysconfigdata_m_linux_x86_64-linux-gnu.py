...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/opt/hostedtoolcache/Python/3.7.7/x64/bin',
 'BINLIBDEST': '/opt/hostedtoolcache/Python/3.7.7/x64/lib/python3.7',
 'BLDLIBRARY': '-L. -lpython3.7m',
 'BLDSHARED': 'gcc -pthread -shared '
              '-Wl,--rpath=/opt/hostedtoolcache/Python/3.7.7/x64/lib '
              '-Wl,--rpath=/opt/hostedtoolcache/Python/3.7.7/x64/lib',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.7.7/x64/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=/opt/hostedtoolcache/Python/3.7.7/x64' "
                "'--enable-shared' '--enable-optimizations' "
                "'LDFLAGS=-Wl,--rpath=/opt/hostedtoolcache/Python/3.7.7/x64/lib'",
 'CONFINCLUDEDIR': '/opt/hostedtoolcache/Python/3.7.7/x64/include',
 'CONFINCLUDEPY': '/opt/hostedtoolcache/Python/3.7.7/x64/include/python3.7m',
 'COREPYTHONPATH': '',
 ...
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/opt/hostedtoolcache/Python/3.7.7/x64 '
             '/opt/hostedtoolcache/Python/3.7.7/x64/lib '
             '/opt/hostedtoolcache/Python/3.7.7/x64/lib/python3.7 '
             '/opt/hostedtoolcache/Python/3.7.7/x64/lib/python3.7/lib-dynload',
 'DESTLIB': '/opt/hostedtoolcache/Python/3.7.7/x64/lib/python3.7',
 'DESTPATH': '',
 'DESTSHARED': '/opt/hostedtoolcache/Python/3.7.7/x64/lib/python3.7/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/hostedtoolcache/Python/3.7.7/x64/include '
                   '/opt/hostedtoolcache/Python/3.7.7/x64/include '
                   '/opt/hostedtoolcache/Python/3.7.7/x64/include/python3.7m '
                   '/opt/hostedtoolcache/Python/3.7.7/x64/include/python3.7m',
 'INCLUDEDIR': '/opt/hostedtoolcache/Python/3.7.7/x64/include',
 'INCLUDEPY': '/opt/hostedtoolcache/Python/3.7.7/x64/include/python3.7m',
 ...
 'LDVERSION': '3.7m',
 'LIBC': '',
 'LIBDEST': '/opt/hostedtoolcache/Python/3.7.7/x64/lib/python3.7',
 'LIBDIR': '/opt/hostedtoolcache/Python/3.7.7/x64/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/opt/hostedtoolcache/Python/3.7.7/x64/lib/pkgconfig',
 'LIBPL': '/opt/hostedtoolcache/Python/3.7.7/x64/lib/python3.7/config-3.7m-x86_64-linux-gnu',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/hostedtoolcache/Python/3.7.7/x64/lib/python3.7',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/opt/hostedtoolcache/Python/3.7.7/x64/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'PY_CORE_LDFLAGS': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.7.7/x64/lib '
                    '-Wl,--rpath=/opt/hostedtoolcache/Python/3.7.7/x64/lib',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,--rpath=/opt/hostedtoolcache/Python/3.7.7/x64/lib '
               '-Wl,--rpath=/opt/hostedtoolcache/Python/3.7.7/x64/lib',
 'PY_LDFLAGS_NODIST': '',
 ...
 'SCRIPTDIR': '/opt/hostedtoolcache/Python/3.7.7/x64/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'datarootdir': '/opt/hostedtoolcache/Python/3.7.7/x64/share',
 'exec_prefix': '/opt/hostedtoolcache/Python/3.7.7/x64',
 'prefix': '/opt/hostedtoolcache/Python/3.7.7/x64',
 'srcdir': '.'}
